...
> **Development archive.** This standalone tree preserves the earlier INC implementation,
> tests, scripts, and design history. The thesis experiments under `simulation-scripts/`
> use the maintained PCM backend in `sim/pcm-sdk_zhiyi` instead.
